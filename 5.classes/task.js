...
if (bookToGive) {
    console.log("Состояние выданной книги: " + bookToGive.state);
    bookToGive.state = 20; // Damaging the book
    console.log("Состояние книги после повреждения: " + bookToGive.state);
    bookToGive.fix(); // Fixing the book
    console.log("Состояние книги после восстановления: " + bookToGive.state);

    library.addBook(bookToGive); // Trying to add the fixed book back to the library
